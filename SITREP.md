...
- **Blog + SpotGuide + Destinations slices fully tested + commented** — suite at **25 tests, 170 assertions**.
...
## Next action
1. Continue the test/comment sweep across public controllers — **Search next**, then Contact (incl. form validation + mocked mail/reCAPTCHA), Pages, Homepage.
